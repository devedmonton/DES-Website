...
export const useMeetupsStore = defineStore("meetups", {
    state: () => ({
        meetups: [
            ...
            {
                name: "Edmonton Data Science Meetup",
                logoSvg: "/img/logos/meetups/DataScience.png",
                ...
                description: `The Edmonton Data Community aims to build a safe space 
                        for folks in the data space to connect, share knowledge and 
                        grow together. Whether you want to talk about Python for Data 
                        Analytics or how to transform business requirements into data 
                        science products, this will be the place for you.`,
            },
        ],
    }),
