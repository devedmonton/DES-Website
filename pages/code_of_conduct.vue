    ...
    <ol>
      <li>
        ...
        <p class="py-2">
          ...
          socioeconomic status, religion (or lack thereof) and any personal
        ...
        <p class="py-2">
          We invite all those who participate in Dev Edmonton Society to help us
      ...
      <li>
        ...
        <p class="py-2">
          ...
          strengthen the relationships between our actions and their effects on
          our community.
        </p>
        <p class="py-2">
      ...
      <li>
        ...
        <ul class="list-disc">
          ...
          <li class="py-1">
            Respect the privacy and dignity of other members and the public.
            Treat the information of others as you'd like yours to be treated.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="py-2 list-disc">
          ...
          <li class="py-1">Inappropriate photography or recording.</li>
          <li class="py-1">
          ...
          <li class="py-1">
            Collecting or sharing personal information (including names, emails,
            avatars, handles, nicknames, messages, emails, or other biographical
            or identifying information) without explicit and prior consent.
          </li>
        </ul>
      </li>
      <li>
        ...
        <p class="py-2">
          In an effort to build a more collaborative and inclusive community, we
          always endevour to resolve disputes and conduct violations through
          education, dialog, and respectful communication. People who
          demonstrate a sincere effort to change behaviour will be given a
          reasonable opportunity to do so, and having done so to participate in
          the community, but continued violations will not be tolerated and may
      ...
      <li>
        ...
        <p class="py-2">
          ...
          applies online (including but not limited to Slack, chats, instant
          messaging, message boards, email, forums, comments) and offline.
        </p>
        <p class="py-2">
      ...
      <li>
        ...
        <p class="py-2">
          ...
          (including fireworks), guns, and large knives such as those used for
          hunting or display, as well as any other item used for the purpose of
          causing injury or harm to others. Anyone seen in possession of one of
          these items will be asked to leave immediately, and will only be
          allowed to return without the weapon.
        </p>
        <p class="py-2">
          Attendees are further expected to comply with all provincial and local
          laws on this matter.
        </p>
      </li>
      <li>
