      ...
      >
        <div class="relative">
          ...
          <p class="mt-3 text-lg leading-7 text-gray-500">
            We are made up of people who believe that an impactful, diverse, and
            collaborative developer community enriches us all. We realize this
            vision by sharing knowledge and ideas, understanding the community
            and its needs, promoting events and initiatives, and supporting
        ...
        <div class="mt-10 -mx-4 relative lg:mt-0">
          <div class="slack-content relative p-4 text-center">
            ...
            <a href="#about-our-slack">
              <VButton appearance="inverted">About Our Slack</VButton>
            </a>
          </div>
        </div>
      </div>
            ...
            <div class="flex-1 bg-white p-6 flex flex-col justify-between">
              <div class="flex-1 flex flex-col">
                <div class="block flex-grow">
                  ...
                  <p class="mt-3 text-base leading-6 text-gray-500">
                    If you are interested in becoming more involved (like
                    borrowing our equiment or voting on community decisions)
                    then
                    <NuxtLink to="/become_a_member" class="text-brand-primary">
                      find more information about becoming a member here.
                    </NuxtLink>
                    You do not need to be a member to come to events or
              ...
              <div class="flex-1 flex flex-col">
                <div class="block flex-grow">
                  ...
                  <p class="mt-3 text-base leading-6 text-gray-500">
                    ...
                    a meetup or organize an event for your favourite language or
                    technologies. We've been there, and want to help!
                  </p>
                  <p class="mt-3 text-base leading-6 text-gray-500">
                ...
                <div class="flex justify-center mt-4">
                  ...
                  >
                    <VButton appearance="inverted">Organize An Event</VButton>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="flex-1 flex flex-col">
                ...
                <div class="flex justify-center mt-4">
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <VButton appearance="inverted">Support Local Tech</VButton>
                  </a>
                </div>
              </div>
            </div>
