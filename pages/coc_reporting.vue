<template>
    <div class="max-w-7xl mx-auto spx-6 px-6 lg:px-8">
        ...
        <p class="py-2">
            ...
            you report it to the Dev Edmonton Society Board by emailing conduct
            AT devedmonton DOT org.
            <strong>All reports will be kept confidential.</strong> In some
            cases we may determine that a public statement will need to be made.
            If that's the case, the identities of all victims and reporters will
        ...
        <p class="py-2">
            <strong>
                ...
                appropriate law enforcement first.
            </strong>
            If you are unsure what law enforcement agency is appropriate, please
            include this in your report and we will attempt to notify them.
        </p>
        <p class="py-2">In your report please include:</p>
        <ul class="list-disc">
            <li class="py-1">
            ...
            <li class="py-1">
                ...
                involved. If there were other witnesses besides you, please try
            ...
            <li class="py-1">If you believe this incident is ongoing.</li>
            <li class="py-1">
        ...
        <p class="py-2">
            You will receive an email from the Dev Edmonton Society
        ...
        <ul class="py-2 list-disc">
            <li class="py-1">What happened.</li>
            <li class="py-1">
                Whether this event constitutes a code of conduct violation.
            </li>
            <li class="py-1">Who the bad actor was.</li>
            <li class="py-1">
        ...
        <p class="py-2">
            ...
            will make a decision as to how to response. Responses may include:
        </p>
        <ul class="py-2 list-disc">
            <li class="py-1">
            ...
            <li class="py-1">A public reprimand.</li>
            <li class="py-1">
                An imposed vacation (i.e. asking someone to "take a week off"
                from a mailing list or IRC).
            </li>
            <li class="py-1">
                A permanent or temporary ban from some or all Dev Edmonton
                Society spaces (mailing lists, Slack, Github, events, etc.)
            </li>
            <li class="py-1">A request for a public or private apology.</li>
        </ul>
        <p class="py-2">
        ...
        <p class="py-2">
            ...
            appropriateness of our response, but we don't guarantee we'll act on
            it.
        </p>
    </div>
</template>
