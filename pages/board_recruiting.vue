  ...
  <div class="max-w-7xl mx-auto spx-6 px-6 lg:px-8">
    ...
    <ol>
      ...
      <li>
        ...
        <p class="py-2">
           DES is looking to build a board that as a collective body excercises essential competencies. We have identified the following compentencies that the board needs to possess.
        </p>
        <p class="py-2">
           <em>Visonary</em>: strong belief in our Mission: “Dev Edmonton Society is made up of people who believe that an impactful, diverse, and collaborative developer community enriches us all. We realize this vision by sharing knowledge and ideas, understanding the community and its needs, promoting events and initiatives, and supporting technology meetups and organizations.”
        </p>
       <p class="py-2">
           <em>Connector</em>: ability to identify and develop relationships to support our society.
        </p>
        <p class="py-2">
           <em>Accountability</em>: To accept responsibility for actions, decisions and policies and to transparently report back to the members of our society as well as knowing our bylaws and procedures.
        </p>
      ...
      <li>
        ...
        <p class="py-2">
          <ul  class="list-disc">
                ...
                <li>Act as advocates and ambassadors for the society and be active participants in advancing the society’s mission</li>
        ...
        <p class="py-2">
          <ul  class="list-disc">
            ...
            <li>Chairs board meetings and is responsible for setting the agenda</li>
            <li>Monitors financial planning and financial reports</li>
            <li>Evaluates the performance of the society in achieving its mission</li>
        ...
        <p class="py-2">
          <ul  class="list-disc">
            ...
            <li>Ensure that the minutes are distributed to members after meetings</li>
            <li>Is familiar with the society’s by-laws and raise applicable by-laws when appropriate</li>
            </ul>
        </p>
         <h3>Treasurer</h3>
        <p class="py-2">
          <ul  class="list-disc">
            ...
            <li>Yearly financial statement submitted to the board for approval</li>
            </ul>
        </p>
      </li>
<li>
