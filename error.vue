<template>
    <div>
        <AppHeader />
        <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-1 flex-col justify-center">

            <Head>
                <Title>Dev Edmonton Society - 404</Title>
                <Meta name="description" content="Our 404 page when the user goes to a wrong page." />
            </Head>
            <h1
            ...
            <div class="mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-3 lg:max-w-none">
                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                    <div class="flex-shrink-0">
                        <NuxtImg
class="h-48 w-full object-cover" src="/404/magnifying-glass-800.jpg"
                            alt="A magnifying glass and pencil on top of a sketchbook filled with notes" width="400" />
                    </div>
                ...
                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                    <div class="flex-shrink-0">
                        <NuxtImg
class="h-48 w-full object-cover" src="/404/css-800.jpg"
                            alt="Macbook laptop open to a text editor with CSS code" width="400" />
                    </div>
                    ...
                    <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                        <div class="flex-1 flex flex-col">
                            ...
                            <div class="flex justify-center mt-4">
                                <a href="https://github.com/devedmonton/devedmonton.com/issues/" target="_blank">
                                    <AppButton appearance="inverted">
                ...
                <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                    <div class="flex-shrink-0">
                        <NuxtImg
class="h-48 w-full object-cover" src="/404/google-800.jpg"
                            alt="Laptop open to the Google Search home page" width="400" />
                    </div>
