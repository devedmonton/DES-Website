...
<div class="code-of-conduct">
  ...
  <p>
    <b>Current Code of Conduct Committee:</b> Kaitlyn Gatineau, Abram Hindle, Jennifer Soule, and Jeremy Nickurak.
  </p>
  <p>
    <b>Current Slack Moderator Code of Conduct Committee:</b> Andrew Steadman, Deepak Joy Jose, and Ace Nasir.
  </p>
  <p>
    If you would like to volunteer, we would LOVE help!
  </p>
  <ol>
    <li>
      <h2>
    ...
    <li>
      ...
      <ol class="multiLevelNumberNotation">
        ...
        <li class="py-1">
          Some channels (for example, <a class="text-primary font-bold"
          href="/opportunities_channel_rules">#opportunities</a>) may have
          their own rules about how to conduct yourself. Make sure to pay
          attention to rules listed or linked in the channel topic and/or
          description.
        </li>
        <li class="py-1">
    ...
    <li>
      ...
      <p>
        If you would like to report someone on the Code of Conduct Committee and do not feel comfortable using the form, please DM someone on the Code of Conduct Committee (not the slack moderators).
      </p>
    </li>
    <li>
      <h2>
