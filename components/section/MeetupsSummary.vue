    ...
    <div class="relative bg-grey-000 pt-8 -mt-8 pb-16 px-4 sm:px-6 lg:pt-12 lg:px-8">
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div
                ...
                <ClientOnly>
                    <ExternalInfoCard v-for="(meetup, index) in shuffledMeetups"
                                      v-bind="meetup"
                                      :key="index">
                        <p v-if="meetup.meetingTime"
                           class="mt-2">
                            {{ meetup.meetingTime }}
                        </p>
                    </ExternalInfoCard>
                ...
                <ViewAll :card-limit="cardLimit"
                         link-to="/meetups">View All Meetups</ViewAll>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    setup(props) {
        ...
        const shuffledMeetups = computed(() => store.getLimitedMeetups(props.cardLimit));
