    ...
    <div class="relative bg-grey-000 pt-8 -mt-8 pb-16 px-4 sm:px-6 lg:pt-12 lg:px-8">
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div
                ...
                <ClientOnly>
                    <ExternalInfoCard v-for="(resource, index) in shuffledResources"
                                      v-bind="resource"
                                      :key="index">
                        <p v-if="resource.meetingTime"
                           class="mt-2">
                            {{ resource.meetingTime }}
                        </p>
                    </ExternalInfoCard>
                </ClientOnly>
                <ViewAll :card-limit="cardLimit"
                         link-to="/resources">View All Resources</ViewAll>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    setup(props) {
        ...
        const shuffledResources = computed(() => store.getLimitedResources(props.cardLimit));
