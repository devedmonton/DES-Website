                ...
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <AppInputStyled id="first_name" name="first_name" />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <AppInputStyled id="last_name" name="last_name" />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <AppInputStyled id="email" name="email" type="email" />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <AppTextAreaStyled id="message" name="message" rows="6" />
                        </div>
